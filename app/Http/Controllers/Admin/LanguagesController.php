...
class LanguagesController extends Controller
{
    ...
    public function store(LanguageRequest $request)
    {
      ...
      {  Language::create($request->except(['_token']));
        return redirect()->route('admin.languages')->with(['success'=>'تم حفظ اللغه بنجاح  ']);
          ...
          return redirect()->route('admin.languages')->with(['error'=>'هناك خطا ما يرجي المحاوله']);
    ...
    public function update($id,LanguageRequest $request)
    {
       ...
       return redirect()->route('admin.languages')->with(['success'=>'تم تحديث اللغه بنجاح  ']);
        ...
        return redirect()->route('admin.languages')->with(['error'=>' هناك خطا ما يرجي المحاوله لاحقا']);
