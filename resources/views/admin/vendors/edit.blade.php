                                    ...
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.vendors.update',$vendor->id)}}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1"> غير لوجو المتجر </label>
...
<script     src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAbZfflIMa_IVNvqb7KwYYpB0wRV9J_YuA&libraries=places&callback=initAutocomplete&language=ar&region=EG
    " async></script>
      @stop
